 ...
 */
final class Version20200227091954 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(30) NOT NULL, lastname VARCHAR(30) NOT NULL, mail VARCHAR(50) NOT NULL, password VARCHAR(100) NOT NULL, avatar VARCHAR(100) NOT NULL, date_u DATE NOT NULL, is_active TINYINT(1) NOT NULL, pseudo VARCHAR(50) NOT NULL, age DATE NOT NULL, roles VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
