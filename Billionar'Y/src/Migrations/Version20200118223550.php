 ...
 */
final class Version20200118223550 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, description_g VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, nb_play INT NOT NULL, img VARCHAR(100) NOT NULL, note INT NOT NULL, nb_note INT NOT NULL, winnings_max INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE member (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, phone VARCHAR(10) DEFAULT NULL, address VARCHAR(100) DEFAULT NULL, postal VARCHAR(5) DEFAULT NULL, city VARCHAR(50) DEFAULT NULL, ip_adress VARCHAR(15) DEFAULT NULL, bank INT NOT NULL, UNIQUE INDEX UNIQ_70E4FA7879F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(30) NOT NULL, lastname VARCHAR(30) NOT NULL, mail VARCHAR(50) NOT NULL, password VARCHAR(50) NOT NULL, avatar VARCHAR(100) NOT NULL, date_u DATE NOT NULL, is_active TINYINT(1) NOT NULL, pseudo VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
